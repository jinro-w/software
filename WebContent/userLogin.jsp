...
<center>
<br><br><br><br><br><br>
<FONT size="6">ログインしてください</FONT><br><br><br>
<form method=post action = "userLogin.jsp">
ID:<input type = "text" name = "userID"><br>
PASS:<input type=password name="passwd" size=16 maxlength=12> <input type = submit value = "ロ
グイン">
</form>
<%
...
if(Conection.user().checkIDwithPass(id, passwd)){
...
%>
<br><br>
<a href="./newAccount.jsp?previousPage=<%=nextPage%>"> 新規アカウント登録はこちら！！</a>
<br><br>
